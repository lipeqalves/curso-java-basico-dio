package edu.dio.palavrasResavadas;

public class PalavrasReservadas {
    /*
     * Palavras reservadas
     * Palavras reservadas, são identificadores de uma linguagem que
     * já possuem uma finalidade específica, portanto,
     * não podem ser utilizados para nomear variáveis, classes, métodos ou
     * atributos.
     * 
     * Controle de Pacotes
     ...
     * volatile: indica que uma variável pode ser alterada durante o uso de
     * threads.;
     * 
     ...
     * default: executa esse bloco de código caso nenhum dos teste de switch-case
     * seja verdadeiro;
     ...
     * independentemente do fluxo de programa seguido ao lidar com uma exceção;
     ...
     * tecnicamente chamados de valores literais, e não keywords. Se você tentar
     * criar algum identificador com estes valores, você também terá um erro de
     * compilação.
     */
}
